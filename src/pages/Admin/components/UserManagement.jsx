...
export function UserManagement() {
  ...
  const [users, setUsers] = useState({
    students: [
      { id: 1, name: 'Ahmed Hassan', email: 'ahmed.hassan@example.com', grade: 'Grade 10', status: 'active', lastActive: '2 hours ago', phone: '0501234567', parent: 'Hassan Mahmoud', enrollDate: '2024-09-01', courses: 8, avgScore: 85 },
      { id: 2, name: 'Fatima Ali', email: 'fatima.ali@example.com', grade: 'Grade 11', status: 'active', lastActive: '5 minutes ago', phone: '0507654321', parent: 'Ali Ahmed', enrollDate: '2024-09-01', courses: 9, avgScore: 92 },
      { id: 3, name: 'Omar Khalil', email: 'omar.khalil@example.com', grade: 'Grade 9', status: 'inactive', lastActive: '2 days ago', phone: '0509876543', parent: 'Khalil Ibrahim', enrollDate: '2024-09-01', courses: 7, avgScore: 78 },
      { id: 4, name: 'Layla Mohamed', email: 'layla.mohamed@example.com', grade: 'Grade 12', status: 'active', lastActive: '1 hour ago', phone: '0503456789', parent: 'Mohamed Abdullah', enrollDate: '2023-09-01', courses: 10, avgScore: 88 },
      { id: 5, name: 'Youssef Ibrahim', email: 'youssef.ibrahim@example.com', grade: 'Grade 10', status: 'active', lastActive: '30 minutes ago', phone: '0506789012', parent: 'Ibrahim Said', enrollDate: '2024-09-01', courses: 8, avgScore: 81 },
    ],
    teachers: [
