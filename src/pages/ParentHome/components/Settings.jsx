...
export default function Settings() {
  ...
  const [email, setEmail] = useState("Sarah.hassan@student.ruwwad.com");
  const [subjectLevel, setSubjectLevel] = useState("Science");
  const [bio, setBio] = useState("Passionate about science ");
        ...
        <div className="settings-main-col">
          ...
          <div className="settings-card" data-section="profile">
            ...
            <div className="settings-avatar-row">
              ...
              <div>
                <h3 className="settings-avatar-name">Sarah Hassan</h3>
