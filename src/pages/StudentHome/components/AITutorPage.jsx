...
// import { Bot, Send, Sparkles, BookOpen, Calculator, Beaker, Microscope, Brain, Lightbulb } from 'lucide-react';
...
//       id: 1,
//       type: 'ai',
//       text: 'Hello! I\'m your AI tutor. I\'m here to help you with any subject, explain concepts, solve problems, and provide study guidance. How can I assist you today? 🤖',
//     },
//   ]);
...
//         type: 'ai',
//         text: 'Great question! Let me break this down for you step by step. This concept is fundamental to understanding the broader topic. Would you like me to provide examples or practice problems to help reinforce your understanding?',
//       };
...
//             <h3 className="text-[#0F172A] mb-4" style={{ fontSize: '16px', fontWeight: '600' }}>
...
//                 >
//                   <p className="text-[#0F172A] mb-1" style={{ fontSize: '14px', fontWeight: '600' }}>
//                     {conv.title}
//                   </p>
//                   <p className="text-gray-600 text-sm truncate mb-1" style={{ fontSize: '12px' }}>
//                     {conv.preview}
//                   </p>
//                   <div className="flex items-center justify-between">
...
//                     }`}
//                   >
//                     <p style={{ fontSize: '15px', lineHeight: '1.6' }}>{message.text}</p>
//                   </div>
//                   {message.type === 'user' && (
...
//                 </Button>
//               </div>
//               <p className="text-gray-500 text-center mt-3" style={{ fontSize: '12px' }}>
...
const Button = ({ children, className = "", ...props }) => (
  <button className={`px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors ${className}`} {...props}>
    {children}
  </button>
);

const Input = ({ type = "text", placeholder, value, onChange, onKeyPress, className = "", ...props }) => (
  <input
    type={type}
    ...
    className={`border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${className}`}
    {...props}
  />
);
...
const Badge = ({ children, variant = "default", className = "" }) => {
  const variants = {
    ...
    gradient: "bg-gradient-to-r from-[#4F46E5] to-[#9333EA] text-white"
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <Badge variant="gradient" className="border-0 px-4 py-2">
          <Sparkles className="w-4 h-4 mr-2" />
          AI Powered
        </Badge>
      </div>
          ...
          <Card className="rounded-2xl border-0 shadow-lg bg-white overflow-hidden">
            ...
            <div className="p-4 bg-white border-t border-gray-200">
              <div className="flex gap-3">
                ...
                <Button
                  onClick={() => handleSend()}
                  className="w-12 h-12 rounded-full p-0 bg-gradient-to-r from-[#4F46E5] to-[#9333EA] hover:opacity-90 flex items-center justify-center"
                >
                  <Send className="w-5 h-5" />
                </Button>
              </div>
