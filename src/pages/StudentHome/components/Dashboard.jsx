...
// الي تحت البوتنز مش شغالين ###############################################################################################

//  import { Card, Button, Badge } from './ui';
// import { FaBook, FaClipboardList, FaChartBar, FaBell, FaCalendar, FaCheckCircle } from "react-icons/fa";
...
//             <Button className="primary">Continue Lesson</Button>
//             <Button className="secondary">Start Quiz</Button>
...
//               <p>Advanced Calculus - Room 204</p>
//               <div className="schedule-meta">
//                 <span className="subject-tag math">Math</span>
...
//             <div className="schedule-content">
//               <h4>Physics Lab</h4>
//               <p>Quantum Mechanics Experiments - Lab 3</p>
//               <div className="schedule-meta">
//                 <span className="subject-tag physics">Physics</span>
//                 <span className="duration">2h</span>
//               </div>
//             </div>
//             <FaCheckCircle className="status-icon upcoming" />
//           </div>
...
//             </div>
//             <div className="schedule-content">
//               <h4>Chemistry Tutorial</h4>
//               <p>Organic Compounds - Online Session</p>
//               <div className="schedule-meta">
//                 <span className="subject-tag chemistry">Chemistry</span>
...
//             <div className="schedule-content">
//               <h4>Study Group</h4>
//               <p>Biology Review - Library Study Room</p>
//               <div className="schedule-meta">
//                 <span className="subject-tag biology">Biology</span>
//                 <span className="duration">1h 30m</span>
//               </div>
//             </div>
//             <FaCheckCircle className="status-icon upcoming" />
...
//             <FaClipboardList className="activity-icon completed" />
//             <div>
//               <h4>Completed Physics Quiz</h4>
//               <p>Scored 95% on Newton's Laws assessment</p>
//             </div>
//             <Badge className="success">95%</Badge>
//           </div>
//           <div className="activity-item">
//             <FaBell className="activity-icon new" />
//             <div>
//               <h4>Teacher Feedback Received</h4>
//               <p>Ms. Sarah commented on your Chemistry report</p>
//             </div>
    ...
    <div className="dashboard-container">
      ...
      <section className="welcome-banner">
        <div className="banner-left">
          ...
          <div className="banner-buttons">
            <Button className="primary" onClick={handleContinueLesson}>
              <FaPlay /> Continue Lesson
            </Button>
            <Button className="secondary" onClick={handleStartQuiz}>
              <FaClipboardList /> Start Quiz
            </Button>
            <Button className="secondary" onClick={handleSubmitAssignment}>
